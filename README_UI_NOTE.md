...
- ui_compact.py: mode 1 native layout, header and real multi-file uploader.
- ui_components.py: isolated filter and address-workflow HTML/CSS/JS.
- app_mode1.py: injects native mode 1 styling once; historical mode1_style.py is no longer injected.
